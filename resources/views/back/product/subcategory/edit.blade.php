   ...
   <div class="row">
       ...
       <!--begin::Portlet-->
		<div class="m-portlet">
			...
			<!--begin::Form-->
			<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="/admin/subcategory/update" enctype="multipart/form-data">
                ...
                <div class="m-portlet__body">
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
							<input class="form-control m-input" name="name" type="text" value="{{ $subcategories->name }}" >
						</div>
					</div>
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
                            <select name="categoryproduct_id" id="categoryproduct_id" class="form-control m-input">
                                <option value="{{ $subcategories->categoryproduct_id }}">{{ $subcategories->categoryproduct->title }}</option>
                                @foreach ($categories as $item)    
                                    @if ($subcategories->categoryproduct_id != $item->id)
                                    <option value="{{ $item->id }}">{{ $item->title }}</option>  
                                    @endif      
                                @endforeach 
                              
                            </select>
                            {{-- <textarea class="form-control m-input" name="deskripsi" id="deskripsi" cols="30" rows="10">{{ $subcategory->deskripsi }}</textarea> --}}
