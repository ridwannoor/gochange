                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item">
                                <a href="/admin/categoryproduct/create"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <img src="{{ url('data_file/productcat/'.$item->image) }}" style="width: 100px; " alt="">
                                        </div>
                                        <div class="col-lg-8">
                                            {{ $item->title }} <br>
                                            {{ $item->deskripsi }}
                                ...
                                <td width="130px">
                                    {{-- <a href="/admin/categoryproduct/show/{{ $item->id }}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill"><i class="flaticon-visible"></i></a> --}}
                                    <a href="/admin/categoryproduct/edit/{{ $item->id }}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill"><i class="la la-edit"></i></a>
                                    <a href="/admin/categoryproduct/destroy/{{ $item->id }}" onclick="return confirm('Are you sure? Delete ')" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill"><i class="flaticon-delete"></i></a>
                                </td>
                            </tr>                            
                            @endforeach
                        </tbody>
