			...
			<form class="m-form m-form--fit m-form--label-align-right" >
                ...
                <div class="m-portlet__body">
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
							<input class="form-control m-input" name="title" type="text" value="{{ $products->title }}" readonly>
						</div>
					</div>
					<div class="form-group m-form__group row">
						<label for="example-search-input" class="col-2 col-form-label">Deskripsi</label>
						<div class="col-10">
                            <textarea class="form-control m-input" name="deskripsi" id="deskripsi" cols="30" rows="10" readonly>{{ $products->deskripsi }}</textarea>
                    ...
                    <div class="form-group m-form__group row">
						...
						<div class="col-10">
                            <select class="form-control m-input" name="categoryproduct_id" id="category_id" >
                                <option value="{{ $products->categoryproduct_id }}" readonly>{{ $products->categoryproduct->title }}</option>
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
                            <input class="form-control m-input" name="harga" type="text" value="{{ $products->harga }}" readonly>
                    ...
                    <div class="form-group m-form__group row">
						...
						<div class="col-10">
                            ...
                            <span>
                                ...
                                {{-- <a href="/product/destroyfile/{{$item->id}}" onclick="return confirm('Are you sure? Delete ')" class="close" aria-label="Close"> </a> --}}
                                <strong>{{$item->image}}</strong>     
                                <img src="{{ url('data_file/product/'.$item->image) }}" width="150px" alt="">
