                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9">
                                          <strong> <a href="/admin/post/show/{{ $item->id }}">{{ $item->title }}</a></strong>  <br>
                                          <span class="m-badge m-badge--success m-badge--wide">{{ $item->tagposts->implode('title', ', ') }}  </span> <br>
                                          {{ $item->comment_count }} <br>
                                            {!! Str::limit($item->deskripsi, 200) !!}
                                        </div>
                                    </div>

                                   {{-- <a href="/admin/post/show/{{ $item->id }}" target="_blank" rel="noopener noreferrer">{{ $item->title }} </a> <br> --}}
                                    {{-- <span class="m-badge m-badge--success m-badge--wide">{{ $item->tagposts->implode('title', ', ') }}  </span> <br>
                                    {{ $item->comment_count }} --}}
                                </td>
                                ...
                                {{-- <td>
                                    <img src="{{url('data_file/'.$item->image)   }}" alt="" width="100px" height="100px">
                                </td> --}}
                                <td>
                                ...
                                <td width="150px">
                                    <a href="/admin/post/publish/{{ $item->id }}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill"><i class="flaticon-multimedia-5"></i></a>
                                    {{-- <a href="/admin/post/show/{{ $item->id }}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill"><i class="flaticon-visible"></i></a> --}}
                                    <a href="/admin/post/edit/{{ $item->id }}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill"><i class="la la-edit"></i></a>
                                    <a href="/admin/post/destroy/{{ $item->id }}" onclick="return confirm('Are you sure? Delete ')" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill"><i class="flaticon-delete"></i></a>
                                </td>
                            </tr>                            
                            @endforeach
                        </tbody>
