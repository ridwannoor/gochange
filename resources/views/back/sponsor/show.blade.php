			...
			<form class="m-form m-form--fit m-form--label-align-right" >
                ...
                <div class="m-portlet__body">
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
							<input class="form-control m-input" name="title" type="text" value="{{ $sponsors->title }}" readonly>
						</div>
					</div>
					<div class="form-group m-form__group row">
						<label for="example-search-input" class="col-2 col-form-label">Deskripsi</label>
						<div class="col-10">
                            <textarea class="form-control m-input" name="deskripsi" id="deskripsi" cols="30" rows="10" readonly>{{ $sponsors->deskripsi }}</textarea>
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
                            <input class="form-control m-input"  value="{{ $sponsors->url }}" readonly>
                    ...
                    <div class="form-group m-form__group row">
						...
						<div class="col-10">
                            ...
                            <img src="{{ url('data_file/'.$sponsors->image) }}" alt="">
						...
						<div class="row">
							...
							<div class="col-10">
                                <div class="btn-group">
                                    ...
                                    <a href="/admin/sponsor" class="btn btn-warning">Back</a>
                                </div>                               
