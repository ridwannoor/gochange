   ...
   <div class="row">
       ...
       <!--begin::Portlet-->
		<div class="m-portlet">
			...
			<!--begin::Form-->
			<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="/admin/gallery/update" enctype="multipart/form-data">
                ...
                <div class="m-portlet__body">
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
							<input class="form-control m-input" name="title" type="text" value="{{ $gallerys->title }}">
						</div>
					</div>
					<div class="form-group m-form__group row">
						<label for="example-search-input" class="col-2 col-form-label">Deskripsi</label>
						<div class="col-10">
                            <textarea id="summernote" name="deskripsi">{!!$gallerys->deskripsi !!}</textarea> 
							{{-- <input class="form-control m-input" name="deskripsi" type="text" value="{{ $gallerys->deskripsi }}" > --}}
						</div>
                    </div>
                    <div class="form-group m-form__group row">
						...
						<div class="col-10">
                            <select class="form-control m-input" name="category_id" id="category_id">
                                <option value="{{ $gallerys->category_id }}">{{ $gallerys->category->title }}</option>
                                @foreach ($categorygallerys as $item)    
                                @if ($gallerys->category_id != $item->id)
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
                            <input class="form-control m-input" name="url" type="url" value="{{ $gallerys->url }}">
