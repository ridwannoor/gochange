			...
			<form class="m-form m-form--fit m-form--label-align-right" >
                ...
                <div class="m-portlet__body">
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
							<input class="form-control m-input" name="title" type="text" value="{{ $services->title }}" readonly>
						</div>
					</div>
					<div class="form-group m-form__group row">
						<label for="example-search-input" class="col-2 col-form-label">Deskripsi</label>
						<div class="col-10">
                            <textarea id="summernote" readonly name="deskripsi">{!!$gallerys->deskripsi !!}</textarea> 
                    ...
                    <div class="form-group m-form__group row">
						...
						<div class="col-10">
                            <select class="form-control m-input" name="category_id" id="category_id" >
                                <option value="{{ $services->category_id }}" readonly>{{ $services->category->title }}</option>
                                {{-- @foreach ($categoryservices as $item)    
                                @if ($services->category_id != $item->id)
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
                            <input class="form-control m-input" name="url" type="url" value="{{ $services->url }}" readonly>
