                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <img src="{{url('data_file/'.$item->image)   }}" alt="" width="100%" >
                                        </div>
                                        <div class="col-lg-9">
                                         <strong> <a href="/admin/gallery/show/{{ $item->id }}">{{ $item->title }} </a></strong>  <br>
                                            {!! $item->deskripsi !!}
                                        </div>
                                    </div>
                                  </td>
                             ...
                             <td>
                                ...
                                <td width="150px">
                                    <a href="/admin/gallery/publish/{{ $item->id }}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill"><i class="flaticon-multimedia-5"></i></a>
                                    {{-- <a href="/admin/gallery/show/{{ $item->id }}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill"><i class="flaticon-visible"></i></a> --}}
                                    <a href="/admin/gallery/edit/{{ $item->id }}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill"><i class="la la-edit"></i></a>
                                    <a href="/admin/gallery/destroy/{{ $item->id }}" onclick="return confirm('Are you sure? Delete ')" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill"><i class="flaticon-delete"></i></a>
                                </td>
                            </tr>                            
                            @endforeach
                        </tbody>
