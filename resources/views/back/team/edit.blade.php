   ...
   <div class="row">
       ...
       <!--begin::Portlet-->
		<div class="m-portlet">
			...
			<!--begin::Form-->
			<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="/admin/team/update" enctype="multipart/form-data">
                ...
                <div class="m-portlet__body">
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
							<input class="form-control m-input" name="title" type="text" value="{{ $teams->title }}">
						</div>
					</div>
					<div class="form-group m-form__group row">
						<label for="example-search-input" class="col-2 col-form-label">Deskripsi</label>
						<div class="col-10">
                            <textarea id="summernote" name="deskripsi">{!!$teams->deskripsi !!}</textarea> 
							{{-- <input class="form-control m-input" name="deskripsi" type="text" value="{{ $teams->deskripsi }}" > --}}
						</div>
                    </div>
                    <div class="form-group m-form__group row">
						...
						<div class="col-10">
                            <select class="form-control m-input" name="category_id" id="category_id">
                                <option value="{{ $teams->category_id }}">{{ $teams->category->title }}</option>
                                @foreach ($categoryteams as $item)    
                                @if ($teams->category_id != $item->id)
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
                            <input class="form-control m-input" name="url" type="url" value="{{ $teams->url }}">
						...
						<div class="row">
							...
							<div class="col-10">
                                <div class="btn-group">
                                    ...
                                    <a href="/admin/team" class="btn btn-secondary"><i class="fa fa-undo" aria-hidden="true"></i>&nbsp; Kembali</a>
                                </div>                               
