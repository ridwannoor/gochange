   ...
   <div class="row">
       ...
       <!--begin::Portlet-->
		<div class="m-portlet">
			...
			<!--begin::Form-->
			<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="/admin/categoryteam/store" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-10">
                                <div class="btn-group">
                                    ...
                                    {{-- <a href="/admin/categoryteam" class="btn btn-secondary">Back</a> --}}
                                </div>                               
