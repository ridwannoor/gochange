   ...
   <div class="row">
       ...
       <!--begin::Portlet-->
		<div class="m-portlet">
			...
			<!--begin::Form-->
			<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="/admin/video/update" enctype="multipart/form-data">
                ...
                <div class="m-portlet__body">
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
							<input class="form-control m-input" name="title" type="text" value="{{ $videos->title }}">
						</div>
					</div>
					<div class="form-group m-form__group row">
						<label for="example-search-input" class="col-2 col-form-label">Deskripsi</label>
						<div class="col-10">
                            <textarea id="summernote" name="deskripsi">{!!$videos->deskripsi !!}</textarea> 
							{{-- <input class="form-control m-input" name="deskripsi" type="text" value="{{ $videos->deskripsi }}" > --}}
						</div>
                    </div>
                    <div class="form-group m-form__group row">
						<label for="example-url-input" class="col-2 col-form-label">Category</label>
						<div class="col-10">
                            <select class="form-control m-input" name="categoryvideo_id" id="categoryvideo_id">
                                <option value="{{ $videos->categoryvideo_id }}">{{ $videos->categoryvideo->title }}</option>
                                @foreach ($categoryvideos as $item)    
                                @if ($videos->categoryvideo_id != $item->id)
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
                            <input class="form-control m-input" name="url" type="url" value="{{ $videos->url }}">
						...
						<div class="row">
							...
							<div class="col-10">
                                <div class="btn-group">
                                    ...
                                    <a href="/admin/video" class="btn btn-secondary"><i class="fa fa-undo" aria-hidden="true"></i>&nbsp; Kembali</a>
                                </div>                               
