			...
			<form class="m-form m-form--fit m-form--label-align-right" >
                ...
                <div class="m-portlet__body">
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
							<input class="form-control m-input" name="title" type="text" value="{{ $banners->title }}" readonly>
						</div>
					</div>
					<div class="form-group m-form__group row">
						<label for="example-search-input" class="col-2 col-form-label">Deskripsi</label>
						<div class="col-10">
                            <textarea class="form-control m-input" name="deskripsi" id="deskripsi" cols="30" rows="10" readonly>{{ $banners->deskripsi }}</textarea>
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
                            <input class="form-control m-input"  value="{{ $banners->url }}" readonly>
                    ...
                    <div class="form-group m-form__group row">
						...
						<div class="col-10">
                            ...
                            <img src="{{ url('data_file/'.$banners->image) }}" alt="">
						...
						<div class="row">
							...
							<div class="col-10">
                                <div class="btn-group">
                                    ...
                                    <a href="/admin/banner" class="btn btn-warning">Back</a>
                                </div>                               
