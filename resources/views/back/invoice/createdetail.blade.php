                                ...
                                <div class="m-invoice__container m-invoice__container--centered">
                                    ...
                                    <div class="m-invoice__items">
                                        <div class="m-invoice__item">
                                            ...
                                            <span class="m-invoice__text">{{ $invoices->perihal }}</span>
                                        </div>
                                        <div class="m-invoice__item">
                                            <span class="m-invoice__subtitle">Catatan</span>
                                            <span class="m-invoice__text">{{ $invoices->catatan }}</span>
                                        </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            @php
                                                ...
                                                // $ppn = $subtotal*10/100;
                                                $total = $subjumlah  + $invoices->lainnya - $invoices->diskon;
                                            @endphp
                                                <tr>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td style="text-align: right">{{ $subjumlah }}</td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td></td> <td></td>
                                                <td class="m--font-danger" style="text-align: right">Diskon</td>
                                                <td class="m--font-danger" style="text-align: right">{{ $invoices->diskon }}</td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td></td> <td></td>
                                                <td class="m--font-brand" style="text-align: right">Lainnya</td>
                                                <td class="m--font-brand" style="text-align: right">{{ $invoices->lainnya }}</td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td></td> <td></td>
                                                <td class="m--font-success" style="text-align: right">Total</td>
                                                <td class="m--font-success" style="text-align: right">{{ $total }}</td>
                                            </tr>
                                        </tfoot>
                                    </table>
